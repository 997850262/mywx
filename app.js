//app.js
import { Provider  } from './libs/redux.js';
import { store } from './store/store.js';
// var redux = require('./libs/redux.js')
// const store = createStore(fn) // redux store
// const WeAppRedux = require('./libs/wechat-weapp-redux.js');
// const { Provider } = WeAppRedux;

// import { createStore, combineReducers, applyMiddleware, compose } from './libs/redux.min'
